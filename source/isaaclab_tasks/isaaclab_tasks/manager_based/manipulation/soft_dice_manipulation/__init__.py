...
gym.register(
    id="Isaac-Soft-Dice-LandingAware-H1-Eval-v0",
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point": (
            f"{__name__}.soft_dice_landing_aware_eval_env_cfg:"
...
gym.register(
    id="Isaac-Soft-Dice-LandingAware-NoPhase-H1-Eval-v0",
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point": (
            f"{__name__}.soft_dice_landing_aware_eval_env_cfg:"
            "SoftDiceLandingAwareNoPhaseEvalEnvCfg"
        ),
        "rsl_rl_cfg_entry_point": (
            f"{agents.__name__}.rsl_rl_ppo_cfg:"
            "SoftDiceTrackingPPORunnerCfg"
...
gym.register(
    id="Isaac-Soft-Dice-Tracking-H1-Play-v0",
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point": (
            f"{__name__}.soft_dice_play_env_cfg:"
            "SoftDiceTrackingPlayEnvCfg"
        ),
        "rsl_rl_cfg_entry_point": (
            f"{agents.__name__}.rsl_rl_ppo_cfg:"
            "SoftDiceTrackingPPORunnerCfg"
...
gym.register(
    id="Isaac-Soft-Dice-LandingAware-H1-Play-v0",
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point": (
            f"{__name__}.soft_dice_play_env_cfg:"
            "SoftDiceLandingAwarePlayEnvCfg"
        ),
        "rsl_rl_cfg_entry_point": (
            f"{agents.__name__}.rsl_rl_ppo_cfg:"
            "SoftDiceTrackingPPORunnerCfg"
